...
@Slf4j
@Aspect
public class HttpPostMappingInterceptor extends BaseIntercept {
    ...
    public Object invoke(ProceedingJoinPoint invocation) throws Throwable {
        ...
        param.put(Metric.REQUEST_METHOD, "POST");
        ...
        if (param.getMetric(Metric.REQUEST_URI) == null) {
            ...
            PostMapping getMapping = targetMethod.getAnnotation(PostMapping.class);
